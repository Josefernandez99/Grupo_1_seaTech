...
const { cloudinaryAddMiddleware, cloudinaryUpdateMiddleware } = require("../middlewares/cloudinary.Middleware");
...
route.post("/create", upload.single('image'), productValidate, cloudinaryAddMiddleware, productsController.create);
...
route.put('/detail/:id/update', upload.single('image'), productValidate, cloudinaryUpdateMiddleware, productsController.update);
